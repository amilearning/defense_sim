...
// function DefenseAreaTable({ defenseAreas, clearDefenseArea }) {
//     const handleClearArea = (areaId) => {
//       if (window.confirm(`Are you sure you want to clear the defense area with ID ${areaId}?`)) {
//         clearDefenseArea(areaId);
//       }
//     };
...
//                 </td>
//                 <td style={{ border: '1px solid black', padding: '8px' }}>
//                   <button onClick={() => handleClearArea(area._id)}>Clear</button>
//                 </td>
//               </tr>
//             ))}
//           </tbody>
